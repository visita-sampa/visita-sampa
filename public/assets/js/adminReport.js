...
function readMore() {
  if (!cardOpen) {
    btnReadMore.innerHTML = "Ver Mais <i class='icon-chevron-down p-1'></i>";
...
let numberOfReport = document.querySelector(".badge-report").innerText;
let badgeReport = document.getElementById("badge-report");

if (numberOfReport == "1") {
  badgeReport.style.backgroundColor = "#dffdee";
  badgeReport.style.color = "#548f74";
  badgeReport.innerHTML = numberOfReport + " " + "Denúncia";
} else if (numberOfReport == "2" || numberOfReport == "3" || numberOfReport == "4" || numberOfReport == "5" || numberOfReport == "6" || numberOfReport == "7" || numberOfReport == "8" || numberOfReport == "9" || numberOfReport == "10") {
  badgeReport.style.backgroundColor = "#dffdee";
  badgeReport.style.color = "#548f74";
  badgeReport.innerHTML = numberOfReport + " " + "Denúncias";
} else if (numberOfReport == "11" || numberOfReport == "12" || numberOfReport == "13" || numberOfReport == "14" || numberOfReport == "15" || numberOfReport == "16" || numberOfReport == "17" || numberOfReport == "18" || numberOfReport == "19" || numberOfReport == "20") {
